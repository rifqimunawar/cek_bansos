  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('s_keluar.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mb-2">
              ...
              <input type="text" class="form-control" required name="tujuan" id="tujuan"
                placeholder="Instansi tujuan" value="{{ old('tujuan', $data->tujuan) }}" />
            </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-action d-flex justify-content-center gap-2">
            ...
            <a href="{{ route('s_keluar.index') }}" class="btn btn-warning btn-sm">Kembali</a>
