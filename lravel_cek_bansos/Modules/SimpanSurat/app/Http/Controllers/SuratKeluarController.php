...
use Modules\SimpanSurat\Models\SuratKeluar;
...
class SuratKeluarController extends Controller
{
  public function index()
  {
    ...
    // dd($data);
    return view(
      'simpansurat::/surat_keluar/index',
      [
        'title' => $title,
        'data' => $data,
      ]
  ...
  public function create()
  {
    ...
    return view(
      'simpansurat::surat_keluar/create',
      [
        'title' => $title,
        'data' => $data,
      ]
  ...
  public function store(Request $request)
  {
    ...
    if ($request->hasFile('lampiran_1')) {
      ...
      $file->move(public_path('/s_keluar'), $newFileName);
    ...
    if (!empty($request->id)) {
      $updateData = SuratKeluar::findOrFail($request->id);
      $data['updated_by'] = Auth::user()->username;
      $updateData->update($data);
      Alert::success('Success', 'Data berhasil diupdate');
      return redirect()->route('s_keluar.index');
    }
  ...
  public function view($id)
  {
    ...
    $url_lampiran1 = $data->lampiran_1 ? $base_url . 's_keluar/' . $data->lampiran_1 : '';
    $url_lampiran2 = $data->lampiran_2 ? $base_url . 's_keluar/' . $data->lampiran_2 : '';
    $url_lampiran3 = $data->lampiran_3 ? $base_url . 's_keluar/' . $data->lampiran_3 : '';
    $url_lampiran4 = $data->lampiran_4 ? $base_url . 's_keluar/' . $data->lampiran_4 : '';
    $url_lampiran5 = $data->lampiran_5 ? $base_url . 's_keluar/' . $data->lampiran_5 : '';
  ...
  {
    $title = "Update Data Surat Keluar";
    Fungsi::hakAkses('/simpan/keluar');
    $data = SuratKeluar::findOrFail($id);
    $data_klasifikasi = KlasifikasiSurat::latest()->get();
    return view(
      'simpansurat::surat_keluar.edit',
      [
        'data' => $data,
        'title' => $title,
