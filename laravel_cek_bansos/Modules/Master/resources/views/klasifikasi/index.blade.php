...
@section('module-content')
  ...
  <div class="panel panel-inverse">
    ...
    <div
      ...
      <a href="{{ route('klasifikasi.create') }}" class="btn btn-primary btn-sm">Tambah &ensp;<i class="fa fa-plus-square"
          aria-hidden="true" style="font-size: 12px"></i></a>
      <div style="display: flex; gap: 10px;">
        {{-- <a href="{{ route('klasifikasi.export') }}" class="btn btn-warning btn-sm">
        ...
        {{-- <a href="{{ route('klasifikasi.pdf') }}" class="btn btn-warning btn-sm">
      ...
      <table id="data-table-default" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
        <thead>
          <tr>
            ...
            <th class="text-nowrap">Nama klasifikasi</th>
          ...
          @foreach ($data as $item)
            <tr class="odd gradeX">
              ...
              <td>
                ...
                <a href="{{ route('klasifikasi.destroy', $item->id) }}" data-confirm-delete="true">
                  <i class="fa fa-trash mx-2" style="font-size: 14px"></i>
                </a>
                {{-- <a href="{{ route('klasifikasi.view', $item->id) }}">
